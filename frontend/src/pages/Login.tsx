...
const Login = () => {
  ...
  return (
    <div className='min-h-screen px-6 bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
      ...
      <div className='mt-4 sm:mx-auto sm:w-full sm:max-w-md'>
        ...
        <div className='relative bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          ...
          <button
            onClick={() => navigate("/")}
            className='absolute -top-3 -right-3 bg-red-100 border border-gray-300 h-12 w-12 rounded-full flex items-center justify-center p-1 shadow hover:bg-red-50 transition'
            aria-label='Close'
          >
            <svg
